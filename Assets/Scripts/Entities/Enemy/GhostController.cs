...
namespace Game.Enemy
{
	...
	{
		public override EnemyType Type { get; } = EnemyType.Ghost;
		...
		void Start()
		{
			...
			int lightLayerMask = (1 << NavMesh.GetAreaFromName("Bright Light")) | (1 << NavMesh.GetAreaFromName("Dim Light"));
			BehaviorTreeLeaf wander = new("Wander", new WanderBehavior(this, Agent, _wanderRadius, _minIdleTime, _maxIdleTime, lightLayerMask));
